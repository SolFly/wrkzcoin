...
const uint64_t LWMA_2_DIFFICULTY_BLOCK_INDEX                 = 100000; // Update this.
...
const float    DIFFICULTY_RESET_MULTIPLIER_V1                = 1;
...
const uint64_t DATABASE_READ_BUFFER_MB_DEFAULT_SIZE          = 64;          // 1 GB
